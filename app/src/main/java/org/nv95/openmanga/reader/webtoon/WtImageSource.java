...
public class WtImageSource {
	...
	private WtImageSource(Bitmap bitmap, boolean cached) {
		this.bitmap = bitmap;
		this.uri = null;
		this.resource = null;
		this.tile = false;
	...
	private WtImageSource(int resource) {
		this.bitmap = null;
		this.uri = null;
	 ...
	 * @return an {@link WtImageSource} instance.
	 */
	public static WtImageSource resource(int resId) {
		return new WtImageSource(resId);
	}
	 ...
	 * @return an {@link WtImageSource} instance.
	 */
	public static WtImageSource asset(String assetName) {
		if (assetName == null) {
	 ...
	 * @return an {@link WtImageSource} instance.
	 */
	public static WtImageSource uri(String uri) {
		if (uri == null) {
		...
		return new WtImageSource(Uri.parse(uri));
	}
	 ...
	 * @return an {@link WtImageSource} instance.
	 */
	public static WtImageSource uri(Uri uri) {
		if (uri == null) {
			throw new NullPointerException("Uri must not be null");
		}
		return new WtImageSource(uri);
	}
	 ...
	 * @return an {@link WtImageSource} instance.
	 */
	public static WtImageSource bitmap(Bitmap bitmap) {
		if (bitmap == null) {
			throw new NullPointerException("Bitmap must not be null");
		}
		return new WtImageSource(bitmap, false);
	}
	 ...
	 * @return an {@link WtImageSource} instance.
	 */
	public static WtImageSource cachedBitmap(Bitmap bitmap) {
		if (bitmap == null) {
			throw new NullPointerException("Bitmap must not be null");
		}
		return new WtImageSource(bitmap, true);
	}
	 ...
	 */
	public WtImageSource tilingEnabled() {
		return tiling(true);
	}
	 ...
	 * @return this instance for chaining.
	 */
	public WtImageSource tilingDisabled() {
		return tiling(false);
	}
	 ...
	 * @return this instance for chaining.
	 */
	public WtImageSource tiling(boolean tile) {
		this.tile = tile;
		return this;
	}
	 ...
	 * @return this instance for chaining.
	 */
	public WtImageSource region(Rect sRegion) {
	 ...
	 * @return this instance for chaining.
	 */
	public WtImageSource dimensions(int sWidth, int sHeight) {
		if (bitmap == null) {
			this.sWidth = sWidth;
